...
# print(var_op._single_excitations)
...
#
# circuit_drawer(var_cirq, filename='uccsd_circuit_h2_4orb_jordanwigner_symm_NoOpt_110119.png',output='mpl')
...
# print(initial_point)
# #initial_point = np.zeros(var_op.num_parameters)
