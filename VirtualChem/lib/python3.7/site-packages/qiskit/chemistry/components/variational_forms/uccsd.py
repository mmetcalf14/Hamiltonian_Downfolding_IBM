...
class UCCSD(VariationalForm):
    ...
    def __init__(self,
        ...
        #self._double_excitations = [[0, 3, 6, 9], [0, 3, 7, 9], [0, 3, 8, 9], [0, 4, 6, 10], [0, 4, 7, 10], [0, 4, 8, 10], [0, 5, 6, 11], [0, 5, 8, 11], [1, 3, 6, 9], [1, 3, 7, 9], [1, 3, 8, 9], [1, 4, 6, 10], [1, 4, 7, 10], [1, 4, 8, 10], [1, 5, 7, 11], [1, 5, 8, 11], [2, 3, 6, 9], [2, 3, 7, 9], [2, 3, 8, 9], [2, 4, 6, 10], [2, 4, 7, 10], [2, 4, 8, 10], [2, 5, 6, 11], [2, 5, 7, 11], [2, 5, 8, 11]]
        ...
        self._logging_construct_circuit = True
        # print(self._single_excitations)
        # print(self._double_excitations)
    ...
    def _build_hopping_operators(self):
        ...
        for op, index in results:
            ...
            if op is not None and not op.is_empty():
                ...
                if len(index) == 2:  # for single excitation
    ...
    def _build_hopping_operator(index, num_orbitals, num_particles, qubit_mapping,
        ...
        Returns:
            ...
            list: index
        """
        # print('How many times did we build this?')
            ...
            for i in range(int(self._reps * self.num_groups)):
                for _ in range(len(self._double_excitations_grouped[i % self.num_groups])):
                    list_excitation_operators.append((self._hopping_ops[counter],
                                                      parameters[i]))
                    counter += 1
        # print('excitation\n',list_excitation_operators[0][0].paulis)
