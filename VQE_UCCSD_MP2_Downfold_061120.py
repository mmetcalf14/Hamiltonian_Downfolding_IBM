...
root_dir = '/Users/mmetcalf/Dropbox/Quantum Embedding/Codes/Lithium_Downfolding/Qiskit Chem/Hamiltonian_Downfolding_IBM/'
NW_data_file = str(root_dir+'H2.yaml')
OE_data_file = str(root_dir+ 'IntegralData/BeH2 RHF/FOCK/BeH2-RHF-DUCC-E2.FOCK')
...
max_eval = 3
optimizer = COBYLA(maxiter=max_eval, disp=True, tol=1e-3, rhobeg=1)
